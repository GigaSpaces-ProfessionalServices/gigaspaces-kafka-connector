...
public class GigaspacesSinkConnectorConfig {
    ...
    protected static ConfigDef configDef() {
        ...
        configDef.define(GS_USERNAME, ConfigDef.Type.STRING, ConfigDef.Importance.MEDIUM, "Username for access a secure space");
        configDef.define(GS_PASSWORD, ConfigDef.Type.STRING, ConfigDef.Importance.MEDIUM, "Password for access a secure space");
        configDef.define(GS_GROUPS, ConfigDef.Type.STRING, ConfigDef.Importance.MEDIUM, "Lookup groups for locating a space");
        configDef.define(GS_LOCATORS, ConfigDef.Type.STRING, ConfigDef.Importance.MEDIUM, "Space lookup locator");
